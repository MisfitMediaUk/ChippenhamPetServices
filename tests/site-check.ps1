...
$logoPath = Join-Path $root 'logo-primary.png'
...
if (-not (Test-Path $logoPath)) { throw 'Missing logo-primary.png' }
...
Assert-Contains $html 'logo-primary.png' 'Missing primary logo reference'
